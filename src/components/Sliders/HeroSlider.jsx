...
const sliderData = [
  {
    id: 1,
    title: "PREMIUM CLEAN BEYOND SHINE",
    maintitle: "BACK TO NEW",
    desp: " Transforming ordinary vehicles into extraordinary masterpieces through meticulous detailing and cutting-edge techniques.",
    url: "/appointment",
    video: "https://videos.pexels.com/video-files/10809162/10809162-hd_1920_1080_25fps.mp4",
  },
  {
    id: 3,
    title: "PPF (Paint Protection Film)",
    maintitle: "10 Years Warranty",
    desp: " Keep your car’s paint flawless with invisible, long-lasting protection.",
    video: "https://videos.pexels.com/video-files/6159374/6159374-hd_1920_1080_30fps.mp4",
  },
];
...
const HeroSlider = () => {
  ...
  return (
    <section className="ak-slider ak-slider-hero-1">
      ...
      {/* <div class final="ak-swiper-controll-hero-1">
...
System: 4 20.9154C20.73 20.6854 20.73 20.314 20.5013 20.0839Z"
                    fill="#fff"
                  />
                </svg>
              </div>
      ...
      <div className="social-hero">
        <Link to="#" className="social-icon1">
